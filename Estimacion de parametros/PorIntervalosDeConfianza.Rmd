...
Li <- (x1 - x2) - qt(1 - alfa/2, k) * sp * sqrt(1**2/n1 + 1**2/n2)
Ls <- (x1 - x2) + qt(1 - alfa/2, k) * sp * sqrt(1**2/n1 + 1**2/n2)
...
Li <- (x1 - x2) - qnorm(1 - alfa/2) * sqrt(sd1_cuadrado/n1 + sd2_cuadrado/n2)
Ls <- (x1 - x2) + qnorm(1 - alfa/2) * sqrt(sd1_cuadrado/n1 + sd2_cuadrado/n2)
